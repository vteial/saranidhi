...
>
> These two require a **`PakshiCalculator` engine refactor + existing-user birth-bird re-migration** (a Phase-2b task — see backlog; carries the v1.4.1 on-load-recalc lesson). Remaining 🔁 Proposed: CONF-PP-003/004/005/006 (T2/T3, non-blocking — resolve during Phase-2b feature work).
