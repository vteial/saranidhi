...
| CONF-011 | 🟢 T3 | Topic 7: கண்ணாடிச் சில்லு சுவாசப் படிவு சோதனை | Verify whether mirror condensation test specifies breath force, distance, or single vs dual nostril | Recorded Videos / Notes | _(prior note: `sugam_tharum_swasa_kalai.pdf` lists shapes on soot-coated glass.)_ | — | ⏳ Pending |
| CONF-016 | 🟢 T3 | Topic 9: பிணி நீக்கும் சுவாசத் தலைகீழ் மாற்றம் | Verify safety contraindications and maximum recommended duration for therapeutic nostril occlusion (cotton plug) | Recorded Videos / Notes | _(prior note: Used until fever/illness breaks; check lineage protocols.)_ | — | ⏳ Pending |
| CONF-019 | 🟢 T3 | Topic 11: வாரச் சரப் பிசகு தோஷ அட்டவணை | Verify whether weekday deviation afflictions (Sunday illness, Monday life-threat, etc.) are same-day immediate omens or cumulative | Recorded Videos / Notes | _(prior note: `gana_sara_nool.pdf` (Peer Mohamed vv. 8–9; Avvaiyar ch. 14).)_ | — | ⏳ Pending |
| CONF-021 | 🟢 T3 | Topic 12: சூரிய ஒளி நீர்த்திவலை வானவில் சோதனை | Clarify physical stance relative to sunlight (standing facing vs back to sun with shadow in front) | Recorded Videos / Notes | _(prior note: `gana_sara_nool.pdf` v. 38 states "காட்டியகால் நிழல்தனக்கு முன்பின் னாகக்".)_ | — | ⏳ Pending |
| CONF-022 | 🟢 T3 | Topic 12: நெய் நிழல் படிம நிறப் பரிசோதனை | Verify if copper vessel (செப்பகல்) and cow's ghee on Amavasya/Pournami are strictly literal in lineage | Recorded Videos / Notes | _(prior note: `gana_sara_nool.pdf` v. 39 specifies molten cow ghee in copper plate.)_ | — | ⏳ Pending |
| CONF-025 | 🟢 T3 | Topic 14: தாம்பூல மூன்று உமிழ்நீர் ரகசியம் | Verify whether 3-saliva betel rule applies to plain leaf or strictly with areca nut and slaked lime | Recorded Videos / Notes | _(prior note: `gana_sara_nool.pdf` p. 102 lists first 2 salivas as toxic/intoxicating, 3rd as amrutham.)_ | — | ⏳ Pending |
...
> ⚠️ **Pending Confirmation [CONF-010]:** In `sugam_tharum_swasa_kalai.pdf` (pp. 16–17), 4 secondary Vayus are listed as வைரன் (Vairan), முக்கியன் (Mukhyan), அந்தரியான் (Anthariyan), and பிரவஞ்சனன் (Pravanjanan). Verify your workshop lineage's definitive list of secondary (Upa) Vayus.
...
> ⚠️ **Pending Confirmation [CONF-011]:** In `sugam_tharum_swasa_kalai.pdf` (p. 35), the mirror condensation test uses soot on glass (*கரி பூசிய கண்ணாடிச் சில்லு*) to reveal shapes: Square (Earth), Crescent (Water), Triangle (Fire), Semicircle (Air), Formless (Space). Cross-verify with your recorded videos whether this requires single-nostril exhalation or natural dual breath, and the exact distance of the glass.
...
> ⚠️ **Pending Confirmation [CONF-016]:** In `sugam_tharum_swasa_kalai.pdf` (p. 42), therapeutic swara inversion requires reversing the active breath at illness onset. Cross-verify with recorded videos regarding safety contraindications (e.g. chronic conditions, respiratory distress) and maximum recommended duration for continuous cotton occlusion during illness.
