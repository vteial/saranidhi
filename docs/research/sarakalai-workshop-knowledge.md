...
> ⚠️ **Pending Confirmation [CONF-009]:** In `sugam_tharum_swasa_kalai.pdf` (p. 28), pre-dawn chakra breath windows are given as fixed civil times: 3:46 AM – 4:53 AM (Ajna: 1,000 breaths) and 4:53 AM – 6:00 AM (Sahasrara: 1,000 breaths), entering Muladhara at 6:00 AM. Verify whether in your workshop lineage these windows are pegged to fixed clock hours or dynamically scaled to local astronomical sunrise (e.g. 5.6 nazhigais before sunrise).
...
> ⚠️ **Pending Confirmation [CONF-012]:** In `sugam_tharum_swasa_kalai.pdf` (p. 35), it is noted that each Tattva rules for a specific time duration (*ஒவ்வொரு தத்துவமும் ஒரு குறிப்பிட்ட கால அளவிற்கே இருந்து பின் மாறும்*). Clarify the exact minute allocation per Tattva taught in your workshop lineage.
...
> ⚠️ **Pending Confirmation [CONF-015]:** In `sugam_tharum_swasa_kalai.pdf` (p. 40), it is emphasized that only Prithvi and Apas grant auspicious success in worldly undertakings, while Agni, Vayu, and Akasa obstruct. Verify whether certain fierce, energetic, travel, or spiritual actions remain viable under Agni/Vayu in your workshop lineage.
