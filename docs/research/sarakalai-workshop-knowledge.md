...
> ⚠️ **Pending Confirmation [CONF-017]:** In `sugam_tharum_swasa_kalai.pdf` (p. 44), 1 matra is defined as 1.5 seconds, giving a 16:64:32 ratio = 24s inhale, 96s retention, 48s exhale. Verify whether beginners in your workshop lineage are taught scaled introductory ratios (e.g. 1:4:2 with 4s:16s:8s) before attempting classical Siddha durations.
