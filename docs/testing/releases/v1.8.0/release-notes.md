...
- **Smoke test:** [`smoke-test.md`](./smoke-test.md) — ✅ **PASS** (2026-09-12; all 6 scenarios + mobile/tablet visual + doctrinal-copy audit, on the PR #184 preview)
- **Docs audit:** [`docs-audit.md`](./docs-audit.md) — ✅ **PASS**
