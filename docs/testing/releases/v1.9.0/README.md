...
doctrinally, in plain language, grouped **Moment / You** (or **Blocked** during an
inauspicious window), with a source citation on every reason. No raw math, no tooltips,
bilingual EN/TA. Scoring math / bands / floor-lock / Oracle path are unchanged
(behavior-preserving).
...
- **Sprint dossier:** [`sprints/sprint-39-why-accordion/`](../../../process/sprints/sprint-39-why-accordion/README.md)
