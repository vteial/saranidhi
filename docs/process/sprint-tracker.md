...
> known CloudKit baseline / 0 regressions, +12 tests); Kiro Web reviewed the real diff and approved
> PR #244. Merged to `main`; release pending (`/release-start v1.12.1`).
>
