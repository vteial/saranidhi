    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          SwitchListTile(
            title: Text(l10n.rahuKaalAlerts),
            subtitle: Text(l10n.rahuKaalAlertsSubtitle),
            value: prefs.notifyRahuKaal,
            onChanged: (v) => notifier.setNotifyRahuKaal(enabled: v),
            dense: true,
          ),
          SwitchListTile(
            title: Text(l10n.morningSummaryAlerts),
            subtitle: Text(l10n.morningSummaryAlertsSubtitle),
